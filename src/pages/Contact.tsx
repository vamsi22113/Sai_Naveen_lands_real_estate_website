...
Message: ${formData.message}`;
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col relative overflow-hidden">
      ...
      <div className="absolute bottom-40 left-0 w-96 h-96 bg-secondary/10 rounded-full blur-[120px] pointer-events-none" />

      {/* ── Dark Hero Header ── */}
      <div className="bg-[#163A22] pb-16 text-center rounded-b-[40px] md:rounded-b-[60px] shadow-lg mb-10 relative z-10 w-full">
        ...
        <section className="px-6 pt-12 md:px-8">
          <div className="animate-fade-rise mx-auto max-w-3xl pb-8">
            ...
            <p className="animate-fade-rise-delay mx-auto mt-6 max-w-xl text-base leading-relaxed text-white/80 sm:text-lg">
              Get in touch with Sai Naveen Lands for your next land investment. We look forward to connecting with you.
            </p>
          </div>
        </section>
      </div>

      <main className="flex-1 px-6 pb-24 md:px-8 max-w-7xl mx-auto w-full relative z-10">
        
        {/* Contact Cards Grid */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
          
          {/* Card: Phone */}
          <div className="group animate-fade-rise-delay flex flex-col rounded-2xl bg-white/70 backdrop-blur-md border border-neutral-200/60 p-6 shadow-sm transition-all duration-300 hover:scale-[1.03] hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)]">
          ...
          <div className="group animate-fade-rise-delay flex flex-col rounded-2xl bg-white/70 backdrop-blur-md border border-neutral-200/60 p-6 shadow-sm transition-all duration-300 hover:scale-[1.03] hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)]">
            ...
            <div className="mt-auto">
              <div className="flex items-center justify-between group/item">
                <a href="mailto:sainaveenlands@gmail.com" className="text-muted-foreground hover:text-primary transition-colors hover:underline trunkcate overflow-hidden text-ellipsis whitespace-nowrap">
          ...
          {/* Card: Instagram */}
          <div className="group animate-fade-rise-delay-2 flex flex-col rounded-2xl bg-white/70 backdrop-blur-md border border-neutral-200/60 p-6 shadow-sm transition-all duration-300 hover:scale-[1.03] hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)]">
            <div className="flex items-center gap-3 mb-4">
          ...
          {/* Card: Location */}
          <div className="group lg:col-span-2 animate-fade-rise-delay-2 flex flex-col rounded-2xl bg-white/70 backdrop-blur-md border border-neutral-200/60 p-6 shadow-sm transition-all duration-300 hover:scale-[1.03] hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)]">
            <div className="flex items-center gap-3 mb-4">
              <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-primary/10 text-primary">
                <MapPin size={18} />
              </div>
        ...
        <div className="animate-fade-rise-delay-2 max-w-2xl mx-auto rounded-3xl bg-white/70 backdrop-blur-xl border border-white/60 p-8 shadow-xl relative overflow-hidden">
          ...
          <div className="text-center mb-8 relative z-10">
            <h2 className="font-serif text-3xl text-foreground">Drop an Enquiry</h2>
